#!/usr/bin/env python3
"""
Skrypt do dodawania pola contributors tylko do plików które mają front matter
"""
...
def has_front_matter(content):
    """Sprawdza czy plik ma front matter"""
    return content.startswith('---') and '---' in content[3:]

def add_contributors(file_path):
    """Dodaje pole contributors do pliku jeśli ma front matter ale nie ma contributors"""
    try:
        with open(file_path, 'r', encoding='utf-8') as f:
            content = f.read()

        # Sprawdź czy plik ma front matter
...
def main():
    ...
    print("🔧 Dodawanie pola contributors (tylko pliki z front matter)...")
